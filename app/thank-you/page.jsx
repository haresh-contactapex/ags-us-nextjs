        ...
        <div className="space-y-24 mx-auto px-6 max-w-6xl">
          <div className="items-center">
            <div data-aos="fade-left">
               ...
               <p className="text-center text-[80px] font-[800] text-[#4BB543]"><i class="fa-solid fa-check"></i> </p>
              ...
              <p class="mx-auto max-w-[900px] text-[#06283b] text-[18px] lg:text-[24px] text-center leading-[1.5]">Thank you for reaching out to us. We will get back to you soon.
